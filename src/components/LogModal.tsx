...
export const LogModal: React.FC = () => {
  ...
  const shelfOptions: { id: ShelfStatus; label: string; desc: string; icon: any }[] = [
    { id: 'played', label: 'Played', desc: 'Finished or experienced', icon: Eye },
    { id: 'playing', label: 'Playing', desc: 'Currently active', icon: Sparkles },
    { id: 'backlog', label: 'Want to Play', desc: 'Save for later', icon: Bookmark },
    { id: 'dropped', label: 'Dropped', desc: 'Stopped playing', icon: X }
  ];
      ...
      >
        ...
        <form onSubmit={handleSave} className="p-5 space-y-5">
          ...
          <div className="pt-1 border-t border-[#232b35]">
            <div className="flex items-center justify-between mb-1.5">
              <label className="text-xs font-bold uppercase tracking-wider text-gray-300">
                Review & Thoughts (Markdown supported)
              </label>
